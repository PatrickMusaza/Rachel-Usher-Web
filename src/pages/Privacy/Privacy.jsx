...
const Privacy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - Rachel Usher Interior Design</title>
        <meta
          name="description"
      ...
      <div className="privacy-policy">
        ...
        <p>
          Rachel Usher Interior Design operates the
          www.rachelusherinteriordesign.com website (the "Service").
        </p>
        <p>
        ...
        <p>
          Rachel Usher Interior Design will take all steps reasonably necessary
        ...
        <ul>
          ...
          <li>
            To protect and defend the rights or property of Rachel Usher
            Interior Design
          </li>
          <li>
        ...
        <p>
          ...
          to perform Service-related services or to assist us in analysing how
          our Service is used.
        </p>
        <p>
        ...
        <ul>
          <li>By email: studio@rachelusher.uk</li>
          <li>
            By visiting this page on our website:{" "}
            <Link to="/get-in-touch">
              rachelusherinteriordesign.com/get-in-touch/
            </Link>
          </li>
        </ul>
      </div>
